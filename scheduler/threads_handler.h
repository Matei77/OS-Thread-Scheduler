...
typedef enum { NEW, READY, RUNNING, WAITING, TERMINATED } thread_state_t;
...
typedef struct scheduler_t {
	...
	priority_queue_t
		*terminated_threads; /* priority queue of terminated threads */
	...
	pthread_t
		*thread_ids; /* array containing the ids of all the threads created */
